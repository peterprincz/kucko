...
import { fadeInFromLeft, fadeInFromRight } from '../hooks/fades'
    ...
    <div>
      ...
      <div className="flex min-h-screen flex-col items-center justify-center py-2">
        ...
        <main className="flex w-full flex-1 flex-col items-center justify-center mx-5 md:mx-20">
          <div className="container mx-auto px-3 md:px-6 lg:px-48 py:3 md:py-6 lg:py-20 flex py-16 max-w-full bg-slate-300">
            <div ref={introRef} className={sectionContentStyle}>
          ...
          <div className="container mx-auto px-3 md:px-6 lg:px-48 py:3 md:py-6 lg:py-20 flex py-16 max-w-full bg-red-200">
            <div className={sectionImageStyle}>
              <img src="https://www.tailwind-kit.com/images/object/8.jpg" className="mr-auto" />
            </div>
            <div className={sectionContentStyle} ref={detailsRef} >
              <h1 className="font-bebas-neue uppercase text-6xl sm:text-8xl font-black flex flex-col leading-none dark:text-white text-gray-800">
                Miket
                <span className="text-5xl sm:text-7xl">
                  ajánlok?
          ...
          <div ref={contactRef} className="container mx-auto px-3 md:px-6 lg:px-48 py:3 py-6 lg:py-20 flex flex-col justify-center items-center dpy-16 max-w-full bg-blue-200">
            ...
            <div className="sm:flex flex-wrap justify-between items-center text-center gap-8">
